...
function getMetadata(data) {
  ...
  // assert(type === 0, `Unexpected ROM type; got 0x${type.toString(16)}, wanted 0`)
  ...
  assert(destination === 0 || destination === 1, `Invalid destination; expected 0x00 or 0x01, got 0x${data[0x014A].toString(16)}.`);
