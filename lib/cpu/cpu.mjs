...
class CPU {
  ...
  executeNextIntruction(debug = false) {
    // if (this.#interrupts.isCPUHalted) {
    //   return 4;
    // }
  ...
  #execute(debug = false) {
    ...
    if (debug) {
      ...
      console.log(`${format.hex(this.#register.PC - 1)}    ${format.instruction(instruction).padEnd(24)} ;${format.hex(opcode)}`);
    }
  ...
  #executeCB(debug = false) {
    ...
    if (debug) {
      ...
      console.log(`${format.hex(this.#register.PC - 1)}    ${format.instruction(instruction).padEnd(24)} ;${this.#register.toString()}`);
    }
