...
import { add, adc, sub, sbc, or, and, xor, cp, inc, ld, ldh } from "./instructions/index.mjs";
...
function execute(intruction, register, data) {
  switch (intruction.mnemonic) {
    ...
    case "INC": return inc(intruction, register, data)
    case "DEC": return inc(intruction, register, data)
    case "LD": return ld(intruction, register, data)
    case "LDH": return ldh(intruction, register, data)
    default:
